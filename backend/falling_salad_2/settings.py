"""
Django settings for falling_salad_2 project.
...
ROOT_URLCONF = 'falling_salad_2.urls'
...
WSGI_APPLICATION = 'falling_salad_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_salad_2 API",
    "DESCRIPTION": "API documentation for falling_salad_2 App",
    "VERSION": "v1",
}
